<template>
  <div
    class="container relative justify-between h-full max-w-6xl px-10 mx-auto xl:px-0 mt-5"
  >
          ...
          <div class="relative h-full ml-0 md:mr-10">
            ...
            >
              ...
              <p class="mb-2 text-gray-600">
                ...
                focus on understanding and analyzing data to provide a semantic
                web.
              </p>
            </div>
          </div>
          ...
          <div class="relative h-full ml-0 mr-0 sm:mr-10">
            ...
            >
              ...
              <p class="mb-2 text-gray-600">
                ...
                defenses and exploiting weaknesses in a computer system or
                network.
              </p>
            </div>
          </div>
